...
unset($__errorArgs, $__bag); ?>" type="text" name="age"
                            id="age" value="<?php echo e($employee->age); ?>" placeholder="Enter Age">
                        <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                    ...
                    <select name="position" id="position" class="form-select">
                        <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $position): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($position->id); ?>"
                                <?php echo e($employee->position->id == $position->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" name="cv" id="cv">
                    <?php $__errorArgs = ['cv'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    <?php if($employee->cv): ?>
                        <small class="text-muted">CV already uploaded: <a
                                href="<?php echo e(asset('storage/' . $employee->cv)); ?>" target="_blank"
                                rel="noopener noreferrer"><?php echo e($employee->cv); ?></a></small>
                    <?php endif; ?>
                </div>
                <hr>
                <div class="row">
...
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\File Utama Javier\Kuliah\Semester 4\Framework\Modul4\Controller_view\resources\views/employee/edit.blade.php ENDPATH**/ ?>